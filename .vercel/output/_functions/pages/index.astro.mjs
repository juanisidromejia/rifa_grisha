import { c as createComponent, m as maybeRenderHead, r as renderTemplate, a as createAstro, h as renderScript, e as addAttribute, b as renderComponent, F as Fragment, d as renderHead } from '../chunks/astro/server_CXndowJ3.mjs';
import 'kleur/colors';
import { $ as $$HeaderGrisha } from '../chunks/HeaderGrisha_RvIQBuxJ.mjs';
import 'clsx';
/* empty css                                 */
...
const $$ImageGallery = createComponent(($$result, $$props, $$slots) => {
  ...
  const defaultImages = [
    "/img/grisha.jpeg",
    // Use the available Grisha image
    "/favicon.jpeg",
    // Use the available favicon
    // Fallback to placeholder images if needed
    "https://via.placeholder.com/600x400/764ba2/ffffff?text=Guitarra+1",
    "https://via.placeholder.com/600x400/667eea/ffffff?text=Guitarra+2"
  ];
